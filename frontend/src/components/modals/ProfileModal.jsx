        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
            ...
            <table className='table greyBorder'>
              <tbody>
                ...
                <tr>
                  <td>managed</td>
                  <td>
                    {<AuditSymbolCompliance status={profile.IsManaged} />}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    {
                      <AuditSymbolCompliance
                        status={profile.HasRemovalPasscode}
                      />
                    }
                  </td>
                </tr>
            ...
            {profile.PayloadContent
              ? profile.PayloadContent.map((content, index) => (
                  <div key={content.PayloadUUID + index}>
                    <hr /> <ProfilePayload profile={content} />{" "}
                  </div>
                ))
              : null}
          </Modal.Body>
